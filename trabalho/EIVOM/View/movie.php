<?php
  ...
  require_once("../19_moviestar/models/dao/ReviewDAO.php");
  ...
  if(empty($id)) {
    ...
    $message->setMessage("O filme não foi encontrado!", "error", "../19_moviestar/index.php");
...
<div id="main-container" class="container-fluid">
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="movie-image-container" style="background-image: url('<?= $BASE_URL ?>../19_moviestar/img/movies/<?= $movie->image ?>')"></div>
    </div>
    <div class="offset-md-1 col-md-10" id="reviews-container">
      ...
      <?php foreach($movieReviews as $review): ?>
        <?php require("../View/user_review.php"); ?>
      <?php endforeach; ?>
